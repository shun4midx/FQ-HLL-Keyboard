...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    private var themes = arrayOf("Unselected", "Shun", "ShunV2", "ShunV3", "Ducky", "DuckyV2", "DuckyV3", "Cabbage", "Sage", "ThisIsFine", "ThisIsFinePremium", "ThisIsFinePremium2", "AntiThisIsFine", "AntiThisIsFinePremium", "AntiThisIsFinePremium2", "Black", "Stargaze", "StargazePremium", "Hammerhead", "CottonCandy", "DarkBlue", "Yellow", "Teal", "Purple", "Green", "Cyan", "ColorBlocks")
