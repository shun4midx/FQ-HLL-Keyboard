...
Java_com_fqhll_keyboard_CustomKeyboardApp_nativeSuggest(
    ...
    unordered_map<string, string> autoreplace = {{"i", "i"}, {"im", "i'm"}, {"Im", "I'm"}, {"id", "i'd"}, {"Id", "I'd"}, {"imma", "i'mma"}, {"Imma", "I'mma"}, {"youd", "you'd"}, {"Youd", "You'd"}, {"youll", "you'll"}, {"Youll", "You'll"}, {"isnt", "isn't"}, {"Isnt", "Isn't"},
                                                 ...
                                                 {"studentss", "student's"}, {"Studentss", "Student's"}, {"whyd", "why'd"}, {"Whyd", "Why'd"}, {"alzheimers", "alzheimer's"}, {"Alzheimers", "Alzheimer's"}, {"cmon", "c'mon"}, {"Cmon", "C'mon"}, {"wedd", "we'd"}, {"Wedd", "We'd"}, {"couldve", "could've"}, {"Couldve", "Could've"}, {"ll", "//"}, {"Ll", "//"}};
